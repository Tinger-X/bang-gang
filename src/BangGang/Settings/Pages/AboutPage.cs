...
internal sealed class AboutPage : SettingsPage
{
    ...
    public AboutPage() : base("软件说明", "这个程序是什么、能做什么、有什么限制")
    {
        ...
        can.Add(new SettingRow("工具调用", "模型可以查时间、算数、读剪贴板与文件、抓网页、看系统信息", Blank()));
        ...
        limits.Add(new SettingRow("不能搜索网页", "网页工具只能抓已知网址，没有搜索功能", Blank()));
        limits.Add(new SettingRow("密钥存在本机", "API Key 明文保存在 settings.json，不上传任何服务器", Blank()));
